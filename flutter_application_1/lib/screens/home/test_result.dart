...
import 'package:flutter_application_1/screens/home/loading.dart';
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text('Know your charachteristics',
                          style: TextStyle(
                            fontSize: 20.0,
                      ...
                      Container(
                          ...
                          child: SingleChildScrollView(
                              ...
                              child: Text(
                                DescConstant().mbtiRes[snapshot.data]['desc'],
                                style: TextStyle(fontSize: 17),
                              ))),
                      SizedBox(
                          height: MediaQuery.of(context).size.height * 0.01),
                      const Text('Your Strength',
                          style: TextStyle(
                            fontSize: 20.0,
                            fontWeight: FontWeight.bold,
                          )),
                      ...
                      Container(
                          ...
                          child: SingleChildScrollView(
                              scrollDirection: Axis.vertical,
                              child: Text(
                                DescConstant().mbtiRes[snapshot.data]
                                    ['strength'],
                                style: TextStyle(fontSize: 17),
                              ))),
                      SizedBox(
                          height: MediaQuery.of(context).size.height * 0.01),
                      const Text('Potential Area of development',
                          style: TextStyle(
                            fontSize: 20.0,
                            fontWeight: FontWeight.bold,
                          )),
